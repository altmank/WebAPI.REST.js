...
webAPI.REST.executeFetchAll = function (entitySetName, fetchXml, extraHeaders, opt_pageNumber, opt_allRecords) {
    ...
    return webAPI.REST.executeFetchXml(entitySetName, escape(fetchXml), extraHeaders)
        .then(function (data) {
            ...
            if (typeof data.body["@Microsoft.Dynamics.CRM.fetchxmlpagingcookie"] !== "undefined") {
                ...
                if (fetchXmlDoc) {
                    ...
                    if (fetchElement) {
                        ...
                        var serializeXML = function (xml) { return new XMLSerializer().serializeToString(xml) };

                        //Serialize fetch to be in the proper format to recursively call executeFetchAll
                        fetchXml = serializeXML(fetchXmlDoc);
                        return webAPI.REST.executeFetchAll(entitySetName, fetchXml, extraHeaders, pageNumber, allRecords);
                    }
                }
            }
            else {
